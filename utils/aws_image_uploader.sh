...
docker buildx build --platform linux/amd64 -t pdf-to-text:$tag  -f ~/Desktop/repos/beis-orp-data-service/lambdas/$image_name_underscored/Dockerfile \
    ~/Desktop/repos/beis-orp-data-service/lambdas/$image_name_underscored/
